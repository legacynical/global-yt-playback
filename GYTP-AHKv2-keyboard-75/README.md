If you have a QMK or a compatible customizable keyboard, you can take advantage of setting F13-24 keys that can be programmed in AHK to do useful stuff when pressed.
