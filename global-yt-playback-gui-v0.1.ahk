...
OpenGUI()
{
  ...
  ; Create GUI
  Gui, Add, Text,, "Active window process: " %activeProcess%
  Gui, Add, Edit,, %activeProcess%
  Gui, Add, Button, gSubmitButton, Submit
  Gui, Show,, Variable Editor
	return
}
